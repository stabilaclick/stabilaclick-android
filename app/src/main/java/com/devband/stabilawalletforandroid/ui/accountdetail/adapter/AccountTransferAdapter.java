package com.devband.stabilawalletforandroid.ui.accountdetail.adapter;
...
public class AccountTransferAdapter extends RecyclerView.Adapter<AccountTransferAdapter.TransactionViewHolder>  implements AdapterDataModel<TransferInfo>, AdapterView {
    ...
    public AccountTransferAdapter(Context context, View.OnClickListener onClickListener) {
    ...
    @NonNull
    @Override
    public AccountTransferAdapter.TransactionViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_my_transfer, null);
        v.setLayoutParams(new RecyclerView.LayoutParams(RecyclerView.LayoutParams.MATCH_PARENT,
                RecyclerView.LayoutParams.WRAP_CONTENT));
        v.setOnClickListener(mOnItemClickListener);
        return new AccountTransferAdapter.TransactionViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull AccountTransferAdapter.TransactionViewHolder holder, int position) {
        ...
        if (Constants.STABILA_SYMBOL.equalsIgnoreCase(info.getTokenName())) {
