...
import com.devband.stabilawalletforandroid.ui.accountdetail.adapter.AccountTransferAdapter;
...
import com.devband.stabilawalletforandroid.common.DividerItemDecoration;
...
public class TransferFragment extends CommonFragment implements TransferView {
    ...
    private View.OnClickListener mOnItemClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (item.getTokenName().equalsIgnoreCase(Constants.STABILA_SYMBOL)) {
