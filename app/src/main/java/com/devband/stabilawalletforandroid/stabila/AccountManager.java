...
import com.devband.stabilawalletforandroid.stabila.repository.AccountRepository;

import org.spongycastle.util.encoders.Hex;
import org.stabila.common.crypto.ECKey;
import org.stabila.common.crypto.Hash;
import org.stabila.common.crypto.SymmEncoder;
import org.stabila.common.utils.Base58;
import org.stabila.common.utils.ByteArray;
import org.stabila.common.utils.FileUtil;
import org.stabila.common.utils.TransactionUtils;
...
public class AccountManager {
        ...
        return Single.fromCallable(() -> {
            ...
            if (imported) {
                ...
                if (accountModel != null) {
                    return Stabila.ERROR_EXIST_ACCOUNT;
                }
            }
    ...
    public int loadAccountByRepository(@Nullable AccountModel accountModel, long lastSelectedIndex) {
        ...
        if (TextUtils.isEmpty(priKeyEnced)) {
            return Stabila.ERROR_ACCOUNT_DOES_NOT_EXIST;
        }
    ...
    public Single<Integer> importAccount(@NonNull String nickname, @NonNull String privateKey, @NonNull byte[] aesKey, boolean imported) {
        ...
        try {
            ...
            ex.printStackTrace();
            return Single.fromCallable(() -> Stabila.ERROR_PRIVATE_KEY);
        }
    }
