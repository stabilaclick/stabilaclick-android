...
import org.stabila.common.crypto.jce.ECKeyAgreement;
...
import static org.stabila.common.utils.ByteUtil.bigIntegerToBytes;
...
//  private static final Logger logger = LoggerFactory.getLogger(ECKey.class);
  ...
  private static PrivateKey privateKeyFromBigInteger(BigInteger priv) {
    if (priv == null) {
      ...
      try {
        ...
        throw new IllegalStateException("Assumed correct key spec statically");
      }
    }
  }
  ...
  public static boolean verify(byte[] data, ECDSASignature signature,
    ...
    try {
      ...
      Log.e(ECKey.class.getSimpleName(), "Caught NPE inside bouncy castle", npe);
      return false;
    }
  }
