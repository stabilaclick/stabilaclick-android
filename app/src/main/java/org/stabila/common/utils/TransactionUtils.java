...
import static org.stabila.common.crypto.Hash.sha256;
...
//          owner = contract.getParameter().unpack(org.stabila.protos.Contract.AccountCreateContract.class).getOwnerAddress();
//          break;
//        case TransferContract:
//          owner = contract.getParameter().unpack(org.stabila.protos.Contract.TransferContract.class).getOwnerAddress();
//          break;
//        case TransferAssetContract:
//          owner = contract.getParameter().unpack(org.stabila.protos.Contract.TransferAssetContract.class).getOwnerAddress();
//          break;
//        case VoteAssetContract:
//          owner = contract.getParameter().unpack(org.stabila.protos.Contract.VoteAssetContract.class).getOwnerAddress();
//          break;
//        case VoteWitnessContract:
//          owner = contract.getParameter().unpack(org.stabila.protos.Contract.VoteWitnessContract.class).getOwnerAddress();
//          break;
//        case WitnessCreateContract:
//          owner = contract.getParameter().unpack(org.stabila.protos.Contract.WitnessCreateContract.class).getOwnerAddress();
//          break;
//        case AssetIssueContract:
//          owner = contract.getParameter().unpack(org.stabila.protos.Contract.AssetIssueContract.class).getOwnerAddress();
//          break;
//        case ParticipateAssetIssueContract:
//          owner = contract.getParameter().unpack(org.stabila.protos.Contract.ParticipateAssetIssueContract.class).getOwnerAddress();
//          break;
//        case DeployContract:
//          owner = contract.getParameter().unpack(org.stabila.protos.Contract.AssetIssueContract.class).getOwnerAddress();
//          break;
